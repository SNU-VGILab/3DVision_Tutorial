...
For a full first-time setup, use `make all`. It builds the Docker image, distributes all lecture
materials to `user0`-`user7`, and launches all 8 containers.
...
1. `make build`
2. `make copy-materials`
3. `make run-users`

After this, you can skip the manual build/material-copy/container-launch steps below unless you
need to customize or rerun a specific part.
